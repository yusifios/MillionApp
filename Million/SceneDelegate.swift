...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    /*var window: UIWindow?
     ...
     name: "Auth",
     bundle: Bundle.main
     ).instantiateViewController(withIdentifier: "AuthController") as? AuthController ?? AuthController()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let newWindow = isLogin ? showMainController(scene: windowScene) : showLoginController(scene: windowScene)
        window = newWindow
        window?.makeKeyAndVisible()
    ...
    private func showMainController(scene: UIWindowScene) -> UIWindow {
        let controller = UIStoryboard.init(
            name: "Main",
            bundle: Bundle.main
        ).instantiateViewController(withIdentifier: "MainController") as? MainController ?? MainController()
